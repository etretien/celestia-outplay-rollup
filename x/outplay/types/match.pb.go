...
// source: outplay/outplay/match.proto
...
func (*Match) Descriptor() ([]byte, []int) {
	return fileDescriptor_12058623a5d48d28, []int{0}
}
...
func (m *Match) GetChallengeId() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*Match)(nil), "outplay.outplay.Match")
}

func init() { proto.RegisterFile("outplay/outplay/match.proto", fileDescriptor_12058623a5d48d28) }

var fileDescriptor_12058623a5d48d28 = []byte{
	// 186 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Match) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Loser) > 0 {
		i -= len(m.Loser)
		copy(dAtA[i:], m.Loser)
		i = encodeVarintMatch(dAtA, i, uint64(len(m.Loser)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Winner) > 0 {
		...
		i = encodeVarintMatch(dAtA, i, uint64(len(m.Winner)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Score) > 0 {
		i -= len(m.Score)
		copy(dAtA[i:], m.Score)
		i = encodeVarintMatch(dAtA, i, uint64(len(m.Score)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.ChallengeId) > 0 {
		...
		i = encodeVarintMatch(dAtA, i, uint64(len(m.ChallengeId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintMatch(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0xa
	}
